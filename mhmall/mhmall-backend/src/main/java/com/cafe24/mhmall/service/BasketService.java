...
public interface BasketService {
	...
	boolean deleteByOptionGuest(Long[] optionNos, Long[] optionCnts, String guestSession);	// 현재 장바구니에 같은 옵션 삭제
	boolean addGuest(Long[] optionNos, Long[] optionCnts, String guestSession);				// 비회원 장바구니 추가
	...
	boolean deleteByOptionMember(String id, Long[] optionNos);			// 현재 장바구니에 같은 옵션 삭제(회원)
	boolean addMember(Long[] optionNos, Long[] optionCnts, String id);	// 회원 장바구니 추가
	...
	boolean deleteAllByOptionNoG(Long[] optionNos, BasketVo basketVo);	// 옵션으로 비회원 장바구니 삭제
	boolean deleteAllByOptionNoM(Long[] optionNos, String id);			// 옵션으로 회원 장바구니 삭제
